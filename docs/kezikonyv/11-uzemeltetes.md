...
| Portál/fizetés | `FRONTEND_BASE_URL`, `API_BASE_URL`, `BARION_POS_KEY`, `BARION_ENV`, `BARION_PAYEE`, `SZAMLAZZ_AGENT_KEY`, `PORTAL_NOTION_API_KEY`, `PORTAL_NOTION_DATABASE_ID` |
| AI | `GEMINI_API_KEY`, `GEMINI_MODEL` |
| Notion import | `NOTION_API_KEY` |
| Frontend | `NEXT_PUBLIC_API_URL`, `NEXT_PUBLIC_BARION_PIXEL_ID` |
