# HYRON — felhasználói útmutató

Ez az útmutató a napi adminmunkához szól. A HYRON az adminisztrációt
...
A bal oldali menüben az **HYRON** csoport. Nyolc aloldal:
...
- **Jóváhagyások** — amit HYRON előkészített, és emberi döntést vár.
- **Tudástár** — a szabályok és jóváhagyott minták. A gépi javaslat mindig külön
  van jelölve az élesben használt szabálytól.
- **Tudásháló** — HYRON tudása egy színes kapcsolati „glóriaként": minden
...
- L0-ban HYRON **csak elemez és javaslatot ír** — nem rögzít kiadást, nem küld
...
1. **Nézd meg a javaslatokat.** A Munkasorban egy feladatra kattintva látod, mit
   elemzett HYRON: a kiolvasott mezőket, az ellenőrzéseket és azt, milyen
   műveletet javasolna.
...
## Tervezetet kérsz HYRON-tól (TIG, szerződés, e-mail)

1. Projektkód-adatlap vagy Utókövetés → **„HYRON teendők"** → **„+ Feladat"**
   (TIG vagy szerződés) — vagy nyiss meg egy meglévő feladatot.
2. A feladat oldalán **„Tervezet készítése (HYRON)"**. HYRON végigmegy a
   ...
   „HYRON (korábbi esetek alapján)"). A hiányzó mező kiemelve látszik.
...
5. E-mailnél a címzett csak ismert címből lehet (a megrendelő kontaktjai, a
   függő felek). Más címet HYRON nem írhat be.

**Összeget HYRON nem talál ki:** csak akkor tölti ki, ha az igazolt forrásban
...
1. **Kapcsold be a tanulást:** HYRON → **Beállítások** → „**Tanulás és
   megfigyelés (L0)**" kapcsoló. Ettől HYRON félóránként megnézi a
...
2. **Első betanítás:** HYRON → **Tanulás és minőség** → „**Visszatekintés
   ...
   **A tanulás kezdete alapból 2026. szeptember 1.** — azóta dolgozunk a HYPE OS
   ...
   jóváhagyhatók), a már jóváhagyott régi példákat pedig HYRON csak az újabbak
   után, kisebb súllyal használja. A dátum a **Beállítások → Tanulás kezdete**
   mezőben módosítható.
3. **Nézd meg, mit tanult:** HYRON → **Tudástár** → „Jóváhagyásra váró
...
4. **Adj neki munkát:**
   - Beérkező számlák (Pénzügyek) → sor végén **„HYRON"** gomb → HYRON
     elemzi, és megnyílik a feladat.
   - Projektkód-adatlap vagy Utókövetés → projektkód → **„HYRON teendők"**
...
5. **Tanítsd a meglévő munkából (kevés új adatnál is):** Tanulás és minőség →
   ...
   (partnerhez és — számlánál — célhoz kötve). Élesítés után HYRON ennél a
...
- **L1** — HYRON előkészít, te véglegesíted (jóváhagyással).
...
A Beállításokban a **Vészleállítás** gomb azonnal letiltja HYRON minden
...
- **Banki utalást HYRON nem indít.** Az utalásnál csak előkészítést készít
  (kit, mennyit, mikorra), a tényleges utalás emberi feladat marad.
- **Új vagy megváltozott bankszámla** esetén HYRON megáll és emberi
  ellenőrzést kér.
