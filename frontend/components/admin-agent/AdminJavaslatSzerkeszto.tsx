...
/** Lara — javaslat szerkesztése (kliens).
 *
 * Amit itt módosítasz, az JAVÍTÁSKÉNT rögzül (ebből tanul Lara), és új
  ...
  return (
    <div className="mt-2 rounded-[var(--radius)] border border-border bg-surface-2 p-3">
      <p className="mb-2 text-[12px] text-text-muted">
        A módosításod javításként rögzül (ebből tanul Lara), és új javaslat készül a régi helyett.
      </p>
