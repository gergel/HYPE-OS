...
/** Lara — Visszajátszás és találati arány (kliens).
 *
 * A tanulás kezdete óta rögzített számláknál összeveti, mit javasolt eredetileg
 * az érkeztető (és ha már elemezte, Lara), és mit döntött végül az ember.
      ...
      {!o || o.szamlak === 0 ? (
        ...
        <>
          ...
          <p className="mt-2 text-[11.5px] text-text-muted">
            ...
            A „Lara találati aránya” azokat a számlákat méri, amelyeket Lara a döntés előtt elemzett.
          </p>
        </>
      )}
    </div>
