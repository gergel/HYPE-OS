/** A HYRON biztonságos alapállását MINDIG láthatóvá tevő csík.
 *
    ...
    return (
      <div className="mb-5 rounded-[var(--radius)] bg-bg-danger px-4 py-3 text-[13px] text-text-danger">
        ...
        <p className="mt-0.5 text-text-danger/80">
          HYRON minden mellékhatásos lépése le van tiltva. A Beállításokban lehet feloldani.
        </p>
      </div>
    );
  }
  if (!modul.engedelyezve) {
    return (
      <div className="mb-5 rounded-[var(--radius)] bg-surface-3 px-4 py-3 text-[13px] text-text-secondary">
        ...
        <p className="mt-0.5">
          HYRON csak elemez és javaslatot készít. Nem ír üzleti rekordot, nem küld e-mailt, és nem indít külső
    ...
    return (
      <div className="mb-5 rounded-[var(--radius)] bg-bg-warning px-4 py-3 text-[13px] text-text-warning">
        ...
        <p className="mt-0.5 text-text-warning/80">
          HYRON dolgozik és javaslatokat készít, de a jóváhagyott műveletek végrehajtása (rekordírás, e-mail) még
