...
export type PortalDetailData = PortalSummary & {
  description: string;
  share_token: string | null;
  /** Az élő feltöltő linkek (több is lehet, akár mappánként külön) - lásd a
   * Feltöltő link sávot a portál-részletnézeten. */
  feltolto_linkek?: { id: number; token: string; folder_id: number | null }[];
