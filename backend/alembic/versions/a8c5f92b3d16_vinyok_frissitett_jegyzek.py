"""Utómunkák vinyó-igazítása a FRISSÍTETT Excel-jegyzék szerint.

A felhasználó 2026-09-01-én frissítette a vinyó-jegyzéket
(Vinyok_projektek_1.xlsx) - az app/data/vinyok_projektek.json az új
tartalommal frissült, ez a migráció pedig újrafuttatja az igazítást azoknak
a környezeteknek, ahol az előző (e5a7c31d8f92) már a régi jegyzékkel
lefutott. A logika ugyanaz:
...
Revision ID: a8c5f92b3d16
Revises: f7b2d84e9a53
"""
...
revision = "a8c5f92b3d16"
down_revision = "f7b2d84e9a53"
branch_labels = None
depends_on = None
