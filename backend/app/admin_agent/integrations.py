"""Admin-Ágens — integráció-állapot (forráskapcsolatok).
...
def integracio_allapotok() -> list[dict]:
    ...
    mondja meg, mely admin-ágens eszközök függenek az adott integrációtól."""
...
def eszkoz_elerheto(eszkoz: str) -> tuple[bool, str | None]:
    """Egy admin-ágens eszköz elérhető-e (a függő integráció konfigurált-e).
