"""Admin-Ágens — visszajátszás a rögzített számlákon + találati arány.
...
* ha az Admin-Ágens már elemezte a számlát a döntés ELŐTT, az ő javaslatát is
  összevetjük (az ügynök saját találati aránya).
...
Csak olvas + az ágens saját tábláiba ír; üzleti rekord nem változik.
...
def _ugynok_javaslata(db: Session, b: BejovoSzamla) -> Cel | None:
    """Az Admin-Ágens utolsó, a jóváhagyás ELŐTT készült javaslata (ha volt)."""
    task = db.scalar(
