    ...
    for event in events:
        ...
        try:
            with db.begin_nested():
                ...
                # dátum-mezőhöz hozzá sem nyúl - a felhasználó kifejezett
                # kérése: a kézzel beállított (pl. záró) dátumot semmilyen
                # automatizmus ne írhassa felül. A név/helyszín/szín/leírás
                # továbbra is a naptárból frissül.
                if not project.forgatas_datum_kezzel_beallitva:
                    ...
                    # származó forgatas_datuma_vege-t - így több napos forgatás
                    # sosem maradt több napos (a felhasználó 2026-08-30-i
                    # hibajelzése; a Notion-import felőli párja:
                    # notion_import/importers_wave2.NAPTAR_SAJAT_MEZOK).
                    # Kivétel: ha az esemény kezdete a régi vég UTÁN-ra került, a
                    # megőrzött vég értelmetlenné vált - azt töröljük.
