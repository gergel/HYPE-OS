...
def szerzodest_igenylo_emberek(
    ...
    """Akiknek a munkájáról egyáltalán szerződés kell - lásd
    services/szamlazo.papirt_igenylo_emberek: a nem belsős stáb, plusz az a
    belsős, akinek ezt a projektjét egy cég számlázza.
