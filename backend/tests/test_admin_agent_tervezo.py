"""Admin-Ágens — TIG/szerződés/e-mail tervezet tesztjei.
...
def test_modell_igazolt_osszeget_elfogad(monkeypatch):
    ...
    assert t["forrasok"]["netto_osszeg"] == "ügynök (igazolt korábbi összeg)"
    assert t["forrasok"]["megbizas_targya"] == "ügynök (korábbi esetek alapján)"
